...
plot(hf_rasterize(terrain), main = "Travel cost (seconds)", col = viridis(50))
...
plot(hf_rasterize(terrain),  main = "No barrier", col = viridis(50))
plot(hf_rasterize(terrain2), main = "Barrier", col = viridis(50))
...
plot(hf_rasterize(terrain),  main = "No channel", col = viridis(50))
plot(hf_rasterize(terrain3), main = "Channel", col = viridis(50))
