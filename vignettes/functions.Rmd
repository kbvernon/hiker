...
Hiking functions all take slope as input and output some ratio of distance (d) to cost, like speed (d/time) or efficiency (d/energy). It's worth noting that different hiking functions assume different representations of slope, degrees, radians, or rise-over-run.

**hiker** currently implements the following hiking functions:  
